  ...
  return (
    <div className="absolute border border-slate-300 shadow-phase h-fit left-0 mt-[40px] mx-auto pb-[32px] right-0 rounded-[8px] w-[788px]">
      <div className="flex gap-x-[24px]">
        <div className="border-b border-b-slate-300 border-r border-r-slate-300 flex h-[273px] items-center justify-center px-[24px] py-[20px] relative rounded-br-[8px] w-[418px]">
          <span className="absolute text-[2.25rem] text-slate-400">
            Set of 5
          </span>
          {store.state.set5.map((card, index) => {
            return (
              <Card
                card={card}
        ...
        <div className="border-b border-b-slate-300 border-l border-l-slate-300 flex h-[273px] items-center justify-center px-[24px] py-[20px] relative rounded-bl-[8px] w-[238px]">
          <span className="absolute text-[2.25rem] text-slate-400">
            Set of 2
          </span>
